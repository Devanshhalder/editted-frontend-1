...
// Two preloaded prototype drafts live on the dedicated Draft Products page.
// Existing AppScope products are intentionally left untouched.
const preloadedDraftCount = 2;
final draftCount =
allProducts.where((p) => !p.published).length + preloadedDraftCount;
...
context,
MaterialPageRoute(
builder: (_) => const DraftProductsScreen(),
),
);
